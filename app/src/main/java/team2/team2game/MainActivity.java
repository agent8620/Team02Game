...
public class MainActivity extends SampleActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        debug = new PreferencesFunctions(this.getPreferences(MODE_PRIVATE)).loadInt("DEBUG",0);
        ...
        mediaPlayer = MediaPlayer.create(this,R.raw.my_game_minus4);
    ...
    void SaveScore(){
        ...
        int score_previous = preferencesFunctions.loadInt("SCORE",0);
    ...
    private void startAnimations() {
        ...
        int index_player = new PreferencesFunctions(this.getSharedPreferences("Team2GameScore",MODE_PRIVATE)).loadInt("PLAYER_SKIN",0);
        if(index_player==-1){
            index_player = new Random().nextInt(10);
            if(index_player==5){
                index_player = new Random().nextInt(10);
            }
        }
        int[] arrayAnimations = getIntArrayOf(players[index_player],4);
